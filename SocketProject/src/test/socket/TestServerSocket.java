...
public class TestServerSocket {
	...
	public static void main(String[] args) throws IOException {
		...
		ArrayList<ServiceThread> threadList = new ArrayList();	// create Thread arrayList
		ArrayList<Socket> clientList = new ArrayList();				// create Socket arrayList
		ArrayList<InputStream> inList = new ArrayList();			// create InputStream arrayList
		ArrayList<OutputStream> outList = new ArrayList(); 		// create OutputStream arrayList
		// <E, K, V, T,...> : Generic type
		server = new ServerSocket(port);								// create SeverSocket
